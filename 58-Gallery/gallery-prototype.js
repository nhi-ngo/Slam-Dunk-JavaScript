function Gallery(gallery) {
  ...
  // save the reference to the gallery that was passed in
...
Gallery.prototype.openModal = function() {
  ...
  // First check if the modal is already open because we have animation when modal is open
...
Gallery.prototype.handleKeyUp = function(e) {
  // if Escape there is no need to check ArrowRight or ArrowLeft. Stop unnecessary function running.
...
Gallery.prototype.showNextImage = function() {
  // console.log(this); // this here binds to the nextButton which is the element on the left side of the 'addEventListener' (Line 48)
